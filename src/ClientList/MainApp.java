...
import ClientList.Model.Person;
import ClientList.Model.PersonListWrapper;
import ClientList.View.PersonEditDlgController;
import ClientList.View.PersonOverviewController;
import ClientList.View.RootLayoutController;
...
public class MainApp extends Application {
    ...
    public void setPersonFilePath(File file) {
        ...
        if (file != null) {
            ...
            window.setTitle("AddressApp - " + file.getName());
        } else {
            prefs.remove("filePath");

            // Update the stage title.
            window.setTitle("AddressApp");
        }
    }
